...
def cnn_classifier_fit(x, y ,n=42):
    
    x, y, index = calculate_3d_feature(x, y,n)
...
#     model.add(keras.layers.MaxPooling1D(5))
    ...
    adam = keras.optimizers.Adam(lr=0.0001, beta_1=0.9, beta_2=0.99, epsilon=None, decay=0.01, amsgrad=False)
...
def lstm_classifier_fit(x, y,n=42):
